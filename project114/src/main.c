...
main (int argc, char *argv[])
{
  ...
  GestionDesServices = create_GestionDesServices ();
  gtk_widget_show (GestionDesServices);
  mcRechercheVC = create_mcRechercheVC ();
  gtk_widget_show (mcRechercheVC);
 ...
 /* modifier = create_modifier ();
  ...
  reponce = create_reponce ();
  gtk_widget_show (reponce);*/
