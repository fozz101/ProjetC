...
enum{
IDa,NOMa,PRENOMa,ADRESSEa,MAILa,PHONEa,ROLa,COLUMNSa
};
...
void affichage(GtkWidget * liste,char id[30]){
...
if(store==NULL){
renderer=gtk_cell_renderer_text_new();
column=gtk_tree_view_column_new_with_attributes("  Identifiant",renderer,"text",IDa,NULL);
gtk_tree_view_append_column(GTK_TREE_VIEW(liste),column);
...
renderer=gtk_cell_renderer_text_new();
column=gtk_tree_view_column_new_with_attributes("  adresse",renderer,"text",ADRESSEa,NULL);
gtk_tree_view_append_column(GTK_TREE_VIEW(liste),column);

renderer=gtk_cell_renderer_text_new();
column=gtk_tree_view_column_new_with_attributes("  E-mail",renderer,"text",MAILa,NULL);
gtk_tree_view_append_column(GTK_TREE_VIEW(liste),column);

renderer=gtk_cell_renderer_text_new();
column=gtk_tree_view_column_new_with_attributes("  Num téléphone",renderer,"text",PHONEa,NULL);
gtk_tree_view_append_column(GTK_TREE_VIEW(liste),column);

renderer=gtk_cell_renderer_text_new();
column=gtk_tree_view_column_new_with_attributes("  Role",renderer,"text",ROLa,NULL);
gtk_tree_view_append_column(GTK_TREE_VIEW(liste),column);

store=gtk_list_store_new(COLUMNSa,G_TYPE_STRING,G_TYPE_STRING,G_TYPE_STRING,G_TYPE_STRING,G_TYPE_STRING,G_TYPE_STRING,G_TYPE_STRING);
...
gtk_list_store_set(store,&iter,IDa,u[i].id,NOMa,u[i].nom,PRENOMa,u[i].prenom,ADRESSEa,u[i].adresse,MAILa,u[i].mail,PHONEa,classe,ROLa,ch,-1);}
...
void affichAZ(GtkWidget * liste,int p){
GtkCellRenderer *renderer;
GtkTreeViewColumn *column;
GtkTreeIter iter;
GtkListStore *store; 
