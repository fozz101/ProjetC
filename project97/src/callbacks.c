...
on_jbButtonchercher_clicked            (GtkWidget       *objet,
                                        gpointer         user_data)
{
GtkWidget *jbCherchervol,*jbListevolallretclient12,*jbTreeviewallret12,*jbTreeviewret;
GtkWidget *Jour;
GtkWidget *Mois;
...
a1.nbre_de_places=a.nbre_de_places;
...
verif_vol_dispo(x,a,tab1,x1,&m1);
verif_vol_dispo(x,a1,tab2,x1,&m2);
